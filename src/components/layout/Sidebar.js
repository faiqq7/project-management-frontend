      ...
      <ul className="space-y-4 w-full">
        <li>
          <Link to="/dashboard" className="flex items-center px-4 py-2 group">
            ...
            <span
              className={`ml-4 text-lg text-gray-800 whitespace-nowrap transition-all duration-300 ${sidebarHovered ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-2 pointer-events-none"} group-hover:font-bold`}
            >
              Dashboard
            </span>
          </Link>
          ...
          <Link to="/projects" className="flex items-center px-4 py-2 group">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 12v2m0 4H6a2 2 0 01-2-2v-5h16v5a2 2 0 01-2 2h-6zm6-10V6a2 2 0 00-2-2h-4a2 2 0 00-2 2v2h8z"
              />
            </svg>
        ...
        <li>
          <Link to="/accounts" className="flex items-center px-4 py-2 group">
            <svg
              className="w-6 h-6 text-gray-700 flex-shrink-0"
              fill="none"
              stroke="currentColor"
        ...
        {userRole === "admin" && (
          <>
            {/* <li>
                            <Link to="/users" className="flex items-center px-4 py-2 group">
        ...
        <li>
          <button
            className="flex items-center px-4 py-2 w-full text-left group"
          ...
          >
            ...
            <span
              className={`ml-4 text-lg text-red-500 whitespace-nowrap transition-all duration-300 ${sidebarHovered ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-2 pointer-events-none"} group-hover:font-bold`}
            >
              Logout
            </span>
          </button>
